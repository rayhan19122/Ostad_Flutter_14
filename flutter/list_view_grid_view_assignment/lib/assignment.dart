        ...
        child: SingleChildScrollView(
          ...
          Column(
            ...
            children: [
              ...
              // Remove Expanded
// Wrap in SizedBox with a specific height
//               SizedBox(
//                 height: 300, // Give it a fixed height (e.g., 300 pixels)
//                 child: ListView.builder(
//                   // shrinkWrap is NOT needed here because the parent (SizedBox) has a size
//                   // physics is NOT needed (or use AlwaysScrollableScrollPhysics)
//                   // to let it scroll naturally
//                   itemCount: packages.length,
//                   itemBuilder: (context, index) {
//                    return TrendingList(
//                       title: packages[index]['title'],
